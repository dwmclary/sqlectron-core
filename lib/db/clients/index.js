...
var _bigquery = require('./bigquery');
...
const CLIENTS = exports.CLIENTS = [{
  ...
  disabledFeatures: ['server:ssl', 'server:host', 'server:port', 'server:user', 'server:password', 'server:domain', 'server:ssh', 'listRoutines', 'listTableTriggers', 'listTableIndexes', 'listSchemas', 'getTableReferences', 'getTableKeys', 'getRoutineCreateScript', 'truncateAllTables']
}];
