...
let executeQuery = exports.executeQuery = (() => {
  var _ref4 = _asyncToGenerator(function* (conn, queryText) {
    var _ref5 = yield driverExecuteQuery(conn, { query: queryText, multiple: true });

    const request = _ref5.request,
          data = _ref5.data;
...
let listTables = exports.listTables = (() => {
  ...
  `;
    ...
    var _ref9 = yield driverExecuteQuery(conn, { query: sql });
...
let listViews = exports.listViews = (() => {
  var _ref10 = _asyncToGenerator(function* (conn, filter) {
    const schemaFilter = (0, _utils.buildSchemaFilter)(filter, 'table_schema');
    const sql = `
    SELECT
      table_schema,
  ...
  `;
    ...
    var _ref11 = yield driverExecuteQuery(conn, { query: sql });
...
let listRoutines = exports.listRoutines = (() => {
  ...
  `;
    ...
    var _ref13 = yield driverExecuteQuery(conn, { query: sql });
...
let listTableColumns = exports.listTableColumns = (() => {
  var _ref14 = _asyncToGenerator(function* (conn, database, table) {
    const sql = `
  ...
  `;
    ...
    var _ref15 = yield driverExecuteQuery(conn, { query: sql });
...
let listTableTriggers = exports.listTableTriggers = (() => {
  var _ref16 = _asyncToGenerator(function* (conn, table) {
    ...
    var _ref17 = yield driverExecuteQuery(conn, { query: sql });
...
let listTableIndexes = exports.listTableIndexes = (() => {
  var _ref18 = _asyncToGenerator(function* (conn, database, table) {
    ...
    var _ref19 = yield driverExecuteQuery(conn, { query: sql });
...
let listSchemas = exports.listSchemas = (() => {
  var _ref20 = _asyncToGenerator(function* (conn, filter) {
  ...
  `;
    ...
    var _ref21 = yield driverExecuteQuery(conn, { query: sql });

    const data = _ref21.data;
...
let getTableKeys = exports.getTableKeys = (() => {
  var _ref26 = _asyncToGenerator(function* (conn, database, table) {
    const sql = `
    SELECT
      tc.constraint_name,
      kcu.column_name,
...
let getTableCreateScript = exports.getTableCreateScript = (() => {
  var _ref28 = _asyncToGenerator(function* (conn, table) {
...
let getViewCreateScript = exports.getViewCreateScript = (() => {
  var _ref30 = _asyncToGenerator(function* (conn, view) {
...
let getRoutineCreateScript = exports.getRoutineCreateScript = (() => {
  var _ref32 = _asyncToGenerator(function* (conn, routine) {
    const sql = `
  ...
  `;
    ...
    var _ref33 = yield driverExecuteQuery(conn, { query: sql });

    const data = _ref33.data;
...
let truncateAllTables = exports.truncateAllTables = (() => {
  var _ref34 = _asyncToGenerator(function* (conn) {
    yield runWithConnection(conn, (() => {
      var _ref35 = _asyncToGenerator(function* (connection) {
    ...
    `;
        ...
        var _ref36 = yield driverExecuteQuery(connClient, { query: sql });

        const data = _ref36.data;
...
let driverExecuteQuery = exports.driverExecuteQuery = (() => {
  var _ref37 = _asyncToGenerator(function* (conn, queryArgs) {
    const runQuery = (() => {
      var _ref38 = _asyncToGenerator(function* (connection) {
